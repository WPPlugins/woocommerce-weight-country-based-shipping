...
Plugin URI: http://www.jeriffcheng.com/wordpress-plugins/woocommerce-weight-country-based-shipping
        ...
        $this->form_fields = array(
        			...
        			'tax_status' => array(
                       ...
                       'options' => array(
                                                    ...
                                                    'type' 			=> 'textarea',
                                                    'description'	=> __( 'Set your weight based rates for country groups (one per line). Example: <strong>Max weight|Cost|country group number</strong>. Example: <strong>100|6.95|3</strong>.', 'woocommerce' ),
                                                    'default'		=> '',
                                            ),
